...
:::caution
You must use .NET SDK 10 or newer. Older versions are unsupported.
:::
...
The template "BepInEx 6 Resonite Plugin (.NET 10, Thunderstore Ready)" was created successfully.
```

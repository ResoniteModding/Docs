...
<Steps>
<ol>
	<li>**Create a new Class Library project** targeting .NET 9</li>
	<li>
		**Add BepInEx references** to your project:
	...
	<li>**Reference Resonite assemblies** from your game folder</li>
	<li>**Set up your development environment** with proper debugging tools</li>

...
import { Card, CardGrid, Steps, Tabs, TabItem, Code, Badge, LinkButton } from '@astrojs/starlight/components';
...
<Steps>
1. **Download BepisLoader** from the official repository
2. **Extract files** to your Resonite installation folder (usually `C:\Program Files (x86)\Steam\steamapps\common\Resonite`)
3. **Verify installation** by checking for the presence of `hostfxr.dll` and `BepisLoader.dll`
4. **Launch Resonite** to initialize BepInEx folder structure
</Steps>

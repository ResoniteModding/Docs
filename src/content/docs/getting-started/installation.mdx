...
<CardGrid>
	<Card title="Gale" icon="rocket">
		...
		<LinkButton href="https://github.com/Kesomannen/gale?tab=readme-ov-file#installation" target={"_blank"} rel={"external"}>
			Install Gale
		</LinkButton>
	</Card>
	<Card title="r2modmanPlus" icon="setting">
		Feature-rich mod manager with profile management and cross-platform support.
		<LinkButton href="https://github.com/ebkr/r2modmanPlus?tab=readme-ov-file#installing" target={"_blank"} rel={"external"}>
